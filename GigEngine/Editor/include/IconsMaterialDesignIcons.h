...
#define ICON_BACK ICON_MD_ARROW_BACK

#define ICON_GAMEOBJECT ICON_MD_SPORTS_VOLLEYBALL
#define ICON_CAMERA ICON_MD_VIDEOCAM
#define ICON_LIGHT ICON_MD_LIGHTBULB
#define ICON_TEXTURE ICON_MD_IMAGE
#define ICON_MODEL ICON_MD_TOKEN
#define ICON_RIGIDBODY ICON_MD_FITNESS_CENTER
#define ICON_COMPONENT ICON_MD_CATEGORY

#define ICON_TRANSFORM ICON_MD_TRANSFORM

#define ICON_DESTROY ICON_MD_DELETE
#define ICON_REMOVE ICON_MINUS
#define ICON_CLONE ICON_MD_CONTENT_COPY

#define ICON_SAVE ICON_MD_SAVE
#define ICON_PLAY ICON_MD_PLAY_ARROW
#define ICON_PAUSE ICON_MD_PAUSE
#define ICON_CLOSE ICON_MD_CLOSE