...
void Interface::Draw()
{
	...
	GigInput::Inputs::UpdateMouseButton(0, ImGui::IsMouseDown(0));
	GigInput::Inputs::UpdateMouseButton(1, ImGui::IsMouseDown(1));
	GigInput::Inputs::UpdateMouseButton(2, ImGui::IsMouseDown(2));
